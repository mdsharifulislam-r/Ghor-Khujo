    ...
    <div className='w-full h-screen bg-[url("/image/hero/pic3.webp")] relative bg-cover'>
      <div className="aboslute w-full h-full left-0 top-0 bg-gradient-to-r from-black/90  to-transparent">
        ...
        <div className='w-full h-screen absolute top-0 left-0 flex flex-col justify-center place-items-center'>
          ...
          <h1 data-aos="fade-up" className='md:text-6xl text-5xl font-bold text-white text-center my-5 leading-[1.2]'>Find Your Dream <br /> House By Us</h1>

          <div data-aos="fade-up" data-aos-delay={5}>
            <Link href={""}   className='px-10 flex place-items-center gap-4 py-4 bg-primary_color text-white hover:bg-white hover:text-black transition-all duration-500 relative before:absolute before:bg-white before:w-full before:h-full before:left-0 before:top-0 before:-z-[1]'>
