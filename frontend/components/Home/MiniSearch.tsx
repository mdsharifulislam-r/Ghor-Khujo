...
export default function MiniSearch() {
  return (
    <div className='w-full min-h-[30vh] flex justify-center container mx-auto '>
      <form action="" className='md:flex grid grid-cols-3 place-items-center md:w-[80%] w-[90%] rounded-md md:gap-6 gap-2 md:px-11 px-3 text-xs -translate-y-20 h-[150px] bg-white border shadow-xl'>
        ...
        <div className='w-full md:col-span-1 col-span-3'>
            <button className='px-10 md:w-fit w-full py-3 hover:bg-white hover:text-primary_color transition-all duration-500 hover:border hover:border-primary_color  bg-primary_color text-white'>Search</button>
        </div>
      </form>
    </div>
  )
